            ...
            <div className="container mx-auto mt-16 px-4">
                ...
                <section className="mb-12">
                    <p className="text-lg text-[#4a5568] mb-6 leading-7">
                        {/* FIX: Replaced unescaped `'` with `&rsquo;` for compliance with `react/no-unescaped-entities`. */}
                    ...
                    <p className="text-lg text-[#4a5568] mb-6 leading-7">
                        ...
                        <Link
                            ...
                            target="_blank"
                            rel="noopener noreferrer" // FIX: Added `rel="noopener noreferrer"` for security.
                ...
                <section className="mb-12">
                    ...
                    <p className="text-lg text-[#4a5568] mb-6 leading-7">
                        TimeBank aims to foster collaboration and trust within communities by creating a platform where people can help each other and earn <strong>TimeCoins</strong>. Whether it&rsquo;s tutoring, cooking, or fixing something, your time and skills can make a difference!
                    </p>
                </section>
                    ...
                    <div className={`${styles.teamCard} bg-white p-6 rounded-lg shadow-md`}>
                        ...
                        <div className="flex justify-center space-x-4">
                            <Link
                                ...
                                target="_blank"
                                rel="noopener noreferrer" // FIX: Added `rel="noopener noreferrer"` for external link security.
                            >
                                {/* FIX: Added meaningful `alt` text to the image for accessibility */}
                                <Image
                                    src="/github-icon.svg"
                                    width={30}
                                    height={30}
                            ...
                            >
                                <Image
                                    ...
                                    width={30}
                                    height={30}
                                    alt="LinkedIn Profile Icon" // FIX: Added meaningful `alt` text for accessibility.
                                    className={`${styles.socialCard}`}
                                />
                            </Link>
                            <Link
                                ...
                                rel="noopener noreferrer" // FIX: Added `rel="noopener noreferrer"` for external link security.
                            >
                                {/* FIX: Added meaningful `alt` text for email icon */}
                                <Image
                                    src="/email-icon.svg"
                                    width={30}
                                    height={30}
